...
<body class=" tracking-normal text-white " style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div class="relative gradient bg-black z-10 flex items-top justify-center min-h-screen  sm:items-center py-4">
        @if (Route::has('login'))
        ...
        <div class="md:pt-24  ">
            <div class="px-3 sm:py-5 mx-auto flex flex-wrap flex-col md:flex-row ">
                <!--Left Col-->
                <div class=" flex-col w-full md:mt-28 sm:mt-10 md:w-2/5 justify-center items-start text-center md:text-center">
                    <p  class="uppercase md:text-2xl text-4xl  text-center w-full">¡Bienvenid@s a Heladeria y comidas rápidas !</p>
                    <h1 style="font-family: 'Pacifico', cursive;" class="my-7 md:text-6xl text-5xl animate-pulse text-center text-sky-600 font-semibold">
                        TsalasH
                    </h1>
    ...
    <div class="h-full grid grid-cols-1  md:grid-cols-2 bg-amber-100 ">
        ...
        <div class="col my-auto h-full mx-3 py-20 text-orange-900 text-lg px-10 text-justify rounded-lg align-middle justify-center ">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="block  md:mt-0 text-white font-bold text-5xl text-center">
                        <img
                            class="object-cover w-full md:h-100 h-48  brightness-90"
    ...
    <div class="md:grid md:grid-cols-2 grid-cols-1 bg-blue-200 ">
        ...
        <div class="col my-auto mx-3 py-28 text-gray-900 text-lg px-10  text-justify rounded-lg  ">
            <h3 style="font-family: 'Pacifico', cursive;" class=" text-5xl text-center pb-10 font-semibold ">¿Quienes Somos?</h3>
        ...
        <div class="col my-auto  bg-blue-400 py-28 text-white text-lg  text-justify  ">
            ...
            <div class="mx-auto"  style="width:610px">
                <iframe  autoplay allow="fullscreen" controls muted frameBorder="0" height="480" src="https://giphy.com/embed/Qa1wpSe2G0HLPpRnth/video?autoplay=1&loop=1&autopause=0" width="640"></iframe>
            </div>
            ...
            <div class="w-full -mx-6 lg:w-2/5">
                <div class="px-6">
                    ...
                    <div class="flex mt-4 -mx-2">
                        <a href="#" class="mx-2 text-gray-200 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" aria-label="Linkden">
                        ...
                        <a href="#" class="mx-2 text-gray-200 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" aria-label="Facebook">
                            <svg class="w-4 h-4 fill-current" viewBox="0 0 512 512">
                                <path d="M455.27,32H56.73A24.74,24.74,0,0,0,32,56.73V455.27A24.74,24.74,0,0,0,56.73,480H256V304H202.45V240H256V189c0-57.86,40.13-89.36,91.82-89.36,24.73,0,51.33,1.86,57.51,2.68v60.43H364.15c-28.12,0-33.48,13.3-33.48,32.9V240h67l-8.75,64H330.67V480h124.6A24.74,24.74,0,0,0,480,455.27V56.73A24.74,24.74,0,0,0,455.27,32Z"/>
                            </svg>
                        </a>

                        <a href="#" class="mx-2text-gray-200 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" aria-label="Twitter">
                            <svg class="w-4 h-4 fill-current" viewBox="0 0 512 512">
            ...
            <div class="mt-6 lg:mt-0 lg:flex-1">
                <div class="grid grid-cols-2 gap-5 sm:grid-cols-3 md:grid-cols-3">
                    <div>
                        ...
                        <a href="#" class="block mt-2 text-sm text-gray-300 dark:text-gray-400 hover:underline">Company</a>
                        <a href="#" class="block mt-2 text-sm text-gray-300 dark:text-gray-400 hover:underline">community</a>
                        <a href="#" class="block mt-2 text-sm text-gray-300 dark:text-gray-400 hover:underline">Careers</a>
                    </div>
                    ...
                    <div>
                        ...
                        <a href="#" class="block mt-2 text-sm text-gray-300 dark:text-gray-400 hover:underline">Helados</a>
                        <a href="#" class="block mt-2 text-sm text-gray-300 dark:text-gray-400 hover:underline">Comidas</a>
                        <a href="#" class="block mt-2 text-sm text-gray-300 dark:text-gray-400 hover:underline">Bebidas</a>
                    </div>

                    <div>
                        <h3 class="text-gray-50 uppercase dark:text-white">Contactanos</h3>
                        <span class="block mt-2 text-sm text-gray-300 dark:text-gray-400 hover:underline">+1 526 654 8965</span>
                        <span class="block mt-2 text-sm text-gray-300 dark:text-gray-400 hover:underline">example@email.com</span>
                        <span class="block mt-2 text-sm text-gray-300 dark:text-gray-400 hover:underline">Calle 25 #5-60</span>
