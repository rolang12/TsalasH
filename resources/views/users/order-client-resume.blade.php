 ...
 <!--falta cuadrar mediaquery yo lo cuadro despues att:cristian-->
 @section('content')
     ...
     <div>
         ...
         <table class="ml-16 py-3   ">
             <tr>
                 <td class="px-6 py-2 font-semibold">Fecha:</td>
                 <td> {{ $fechaActual = date('d-m-Y H:i:s') }} </td>
             </tr>
             <tr>
                 <td class="px-6 py-2 font-semibold">ID Pedido:</td>
                 <td>id</td>
             </tr>
             <tr>
                 <td class="px-6 py-2 font-semibold">Nombre:</td>
                 <td> {{ Auth::user()->name . ' ' . Auth::user()->last_name }} </td>
             </tr>
             <tr>
                 <td class="px-6 py-2 font-semibold">Telefono:</td>
                 <td> {{ Auth::user()->phone }}</td>
             </tr>
             <tr>
                 <td class="px-6 py-2 font-semibold">Dirección:</td>
                     ...
                     <table wire.init="loadUsers">
                         ...
                         <tbody class="bg-white">
                             ...
                             <tr class="border-t border-gray-400 ">
                                 <td></td>
                                 <td></td>
                                 <td class="font-bold px-6 py-4 ">Total</td>
