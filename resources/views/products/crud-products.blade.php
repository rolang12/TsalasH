...
@section('content')
    ...
    <div class="grid grid-cols-2 mt-20 -mb-16 items-center">

        <div class="md:w-auto w-screen">
            <h2 class="text-3xl font-bold px-3 ml-6 "> Tabla de Productos</h2>
        </div>

        <div class="flex md:justify-end justify-center mr-0 md:mr-6 md:mt-0 mt-36 ">
    ...
    <!--Table-->
    <div id='recipients' class="p-10 md:mt-36 mt-5 lg:mt-20 rounded  shadow ">
