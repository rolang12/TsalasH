    ...
    <div class="md:mt-10 mt-5 grid md:grid-cols-3 grid-cols-1 lg:grid-cols-4 px-3 py-auto items-center">
        ...
        @foreach ($foods as $food)
            ...
            <div class="col  my-4 p-3 mx-2 transform hover:scale-105 motion-reduce:transform-none duration-500 overflow-hidden bg-white rounded-lg shadow-sm dark:bg-gray-800">
                <div class="py-2 ">
                    <h1 class="text-3xl font-semilight text-gray-800 font-principal dark:text-white">{{$food->name}}</h1>
                ...
                <div class="grid grid-cols-2 justify-between px-4 py-1 bg-gray-100  ">
                   ...
                   <a class="justify-self-end my-auto " href="{{ route ('products.crud.show-product', ['id' => $food->id ]) }}" ><i class="fa-solid  text-purple-700 font-extrabold text-xl fa-eye"></i></a>
                </div>
                ...
                <form class="text-left border-none bg-gray-100  rounded-b-lg" action="{{route('cart.cart.add')}}" method="POST" >
                    ...
                    <div class="grid grid-cols-3 " >
                        ...
                        <input class="justify-self-center my-auto text- border-none -ml-28 w-1/2 text-lg   bg-transparent text-left " placeholder="0" min="0" max="15" type="number" class="w-5" name="quantity" id="quantity">
