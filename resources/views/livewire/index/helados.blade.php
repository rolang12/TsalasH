    ...
    <div class="md:mt-10 mt-5 grid md:grid-cols-3 grid-cols-1 lg:grid-cols-4 px-3 py-auto items-center">
        ...
        @foreach ($iceCreams as $item)
            <div <div
                ...
                <div class="py-2">
                    <h1 class="2xl:text-3xl lg:text-2xl font-semilight text-gray-800 font-principal dark:text-white">
                        {{ $item->name }}

                    </h1>
                    <p class="mt-1 lg:text-1xl  font-light text-gray-600 dark:text-gray-400">{{ $item->description }}
                    </p>
                </div>
                <a class="justify-self-end my-auto "
                    href="{{ route('products.crud.show-product', ['id' => $item->id]) }}">
                    ...
                    <div class="grid grid-cols-2 justify-between px-4 py-2 bg-gray-100 rounded-b-lg">
                        <h1 class="lg:text-sm  py-3 text-left font-semibold text-gray-600">Precio:
                            ${{ $item->price }} COP
                        </h1>
