    ...
    <div class="md:mt-10 mt-5 grid md:grid-cols-3 grid-cols-1 lg:grid-cols-4 px-3 py-auto items-center">
        ...
        @foreach ($bebidas as $bebida)
            ...
            <div class="col my-4 p-3 mx-2 transform hover:scale-105 motion-reduce:transform-none duration-500 overflow-hidden bg-white rounded-lg shadow-md">
                <div class="py-2">
                    <h1 class="text-3xl  font-light text-gray-800 font-principal dark:text-white">{{$bebida->name}}</h1>
                ...
                <div class="grid grid-cols-2 justify-between px-4 py-1 bg-gray-100 ">
                    ...
                    <a class="justify-self-end my-auto " href="{{ route ('products.crud.show-product', ['id' => $bebida->id ]) }}" ><i class="fa-solid  text-purple-700 font-extrabold text-xl fa-eye"></i></a>
                </div>
                ...
                <form class="text-left border-none bg-gray-100 rounded-b-lg" action="{{route('cart.cart.add')}}" method="POST" >
                    ...
                    <div class="grid grid-cols-3 " >
                        ...
                        <input class="mr-3  justify-self-end my-2 border-none text-base p-3  rounded-lg font-bold text-white transition-colors duration-200  transform bg-purple-500 hover:bg-purple-600 focus:bg-purple-900 focus:outline-none" type="submit" name="btn" value="Añadir al Carrito">
                    </div>
