<div>
    ...
    <form  class="text-left " action="{{route('cart.cart.add')}}" method="POST" >
        ...
        <button  type="submit" id="btn1" name="btn" value="Añadir al Carrito" class="flex font-semibold float-right my-5 text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded"> 
           Añadir al Carrito
        </button>
