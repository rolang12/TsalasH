...
<footer class="gradient-2 px-7 pt-7 test text-white">
    <div class="container px-6 pt-4 pb-1 mx-auto">
        <div class="lg:flex">
            <div class="w-full -mx-6 lg:w-2/5">
                <div class="px-6">
                    ...
                    <p class="max-w-md mt-2 text-gray-200 dark:text-gray-400">Estamos ubicados en el municipio de Rovira
        ...
        <div class="bottom-0">
            <p class="text-center text-gray-400 dark:text-white">© TSalasH Heladería del Parque 2022 - Todos los
